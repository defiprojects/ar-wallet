...
const useSendTransfer = () => {
    ...
    const sendTransfer = async (to: string | Promise<string>, value: string, from: string | Promise<string>, key: ethers.utils.BytesLike | ExternallyOwnedAccount | ethers.utils.SigningKey) => {
        try {
            setLoading(true);
    ...
    return { sendTransfer, loading, success };
};
